...
This information includes specifics for Inventory Management. For additional information, see the Orders section.
...
![Multiaddress at Checkout](https://docs.magento.com/m2/ce/user_guide/Resources/Images/inventory/inventory-multi-ship_thumb_0_0.png)

### Refunds

When entering a credit memo to issue a refund, you have an option to return the product quantity to the deducted source. The order information includes the inventory source that shipped the product. We recommend awarding the returned product quantity through a credit memo when you receive the returned product.

![Items to Refund with Return to Stock Selected](https://docs.magento.com/m2/ce/user_guide/Resources/Images/credit-memo-items-to-refund_thumb_0_0.png)
